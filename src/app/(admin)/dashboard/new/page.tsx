...
import { FormDefinition, WordForm, Language, DefinitionField } from "@/lib/types";
...
export default function NewWordPage() {
    ...
    const handleDefinitionChange = (defIndex: number, field: keyof FormDefinition, value: string) => {
        setForm((prev) => {
